...
// 	// Box restrictions
// 	ocp.subjectTo(3.0 <= vx <= 10.0);
// 	ocp.subjectTo( AT_END , vx <= 5.0);
// 	ocp.subjectTo(-1.0 <= mu <= 1.0);
// 	ocp.subjectTo(-pi/5 <= delta <= pi/5);
// 	ocp.subjectTo(-0.4 <= D <= 0.4);
...
// 	IntermediateState	sp, ax, rp;
// 	IntermediateState	T;

// 	OnlineData k;

// 	const double		m = 300.0;
// 	const double		Cm=4600;//230*45/11/0.202;
// 	const double 		Cr=180;
// 	const double 		Cd=0.7;
// 	const double 		WB=1.535;
// 	const double 		l_R=0.5*WB;
...
// 	f << dot( vx ) == ax;
// 	f << dot( vy ) == (deltap*vx + delta*ax)*l_R/WB;
// 	f << dot( r ) == 0.9*(deltap*vx + delta*ax)*WB;
// 	f << dot( D ) == Dp;
// 	f << dot( delta ) == deltap;
...
// 	ocp.subjectTo(-1.2 <= mu <= 1.2);
// 	ocp.subjectTo(-pi/5 <= delta <= pi/5);
// 	ocp.subjectTo(-1.0 <= D <= 1.0);
// 	ocp.subjectTo(-30.0 <= deltap <= 30.0);
// 	ocp.subjectTo(-300 <= Dp <= 300);
// 	// ocp.subjectTo(-6<= vx*vx*k <= 6);	
// 	// ocp.subjectTo( AT_END, 0.0 <= vx <= 6.0);
