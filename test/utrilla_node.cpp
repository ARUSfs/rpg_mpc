...
void callback(const std_msgs::Float32MultiArray::ConstPtr& msg, ros::Publisher& pub, ros::Publisher& pub_pred, ros::Publisher& pub_pred_r){
	...
	// std_msgs::Float32 pred_r;
	// pred_r.data=prediccion[5];
...
int main(int argc, char **argv){
	...
	ros::Publisher pub_pred_r = n.advertise<std_msgs::Float32>("pred_r",1);

    ros::Subscriber sub = n.subscribe<std_msgs::Float32MultiArray>("/curvilineas/x", 1000,
         boost::bind(callback, _1, boost::ref(pub), boost::ref(pub_pred), boost::ref(pub_pred_r)));
